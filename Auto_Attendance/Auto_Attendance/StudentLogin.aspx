<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="StudentLogin.aspx.cs" Inherits="PatientLogin" %>
    ...
    <table width="60%" style="background-image: url('Images/bg.jpg'); " class="intLog">
            <tr>
                ...
                <td width="50%" class="intLog"
                    ...
                    align="center">
                    <asp:Label ID="Label1" runat="server" Text="-- Student Login --" Font-Size="XX-Large" 
